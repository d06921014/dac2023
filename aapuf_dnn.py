...
def prepareChallenges(length, nrof_chs, mode = 'SAC', bias = 0.1, ratio = 0.85, shuffle=True):
...
nrof_chs = 600000#2600000
invFunction = 'ANDOR' #ANDOR #'XOR'#'TFF_AND'
mode = 'RANDOM' #SAC #B-ADD-RAND #BIASED #RANDOM
nrof_tr_bits = 40
nlayers = 2
